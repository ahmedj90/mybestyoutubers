        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'icon_color' ) ); ?>">
                    ...
                    <option value="dark" <?php selected( $icon_color, 'dark' ); ?>><?php esc_html_e( 'dark', 'g1_socials' ) ?></option>
                    <option value="light" <?php selected( $icon_color, 'light' ); ?>><?php esc_html_e( 'light', 'g1_socials' ) ?></option>
                </select>
            </p>
        <?php
        }
