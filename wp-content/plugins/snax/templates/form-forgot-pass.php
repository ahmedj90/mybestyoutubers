	...
	<div class="snax-forgot-pass-form" data-snax-nonce="<?php echo esc_attr( wp_create_nonce( 'snax-ajax-forgot-pass-nonce' ) ); ?>">
		<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
			...
			<p class="forgot-username">
				...
				<input type="text" name="user_login" id="user_login" class="input" value="" size="20" placeholder="<?php esc_html_e( 'Username or Email Address' ); ?>" />
			</p>
			<?php
			/**
			...
			<p class="forgot-submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="<?php esc_attr_e( 'Reset password', 'snax' ); ?>" />
			</p>
